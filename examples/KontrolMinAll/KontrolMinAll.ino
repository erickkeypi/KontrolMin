...
void loop(){
  ...
  kontrol.addListener("fs",functionString); //send {fs:prueba} through serial
  ...
  kontrol.addListener("fl",functionLong); //send {fl:100000} through serial
...
void functionString(String arg){
  Serial.print(F("Function with argument String: "));
  Serial.println(arg);
}
void functionBoolean(boolean arg){
...
void functionLong(long arg){
  Serial.print(F("Function with argument long: "));
  Serial.println(arg);
}
